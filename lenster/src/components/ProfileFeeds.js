...
function ProfileFeeds() {
  return (
    <div className="ProfilefeedArea">
        
      <div className="Profilepost-container first">
        <div className="post">
          <img
          ...
          <div className="Prouser-name">Heybela</div>
          <div className="Profileline1"></div>
          <div className="Prouser-details">
            <span className="Prouser-id">@Heybela</span>
            <span className="Prouser-dot">.</span>
            <span className="Protime">3h</span>
          </div>
